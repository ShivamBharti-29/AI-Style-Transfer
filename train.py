...
def  parse_arguments():
    ...
    parse.add_argument('--content_dir' , type=str, default='D:/adain-style-transfer/content_data',help='Location of content dataset')
    parse.add_argument('--style_dir' , type=str, default='D:/adain-style-transfer/style_data',help='Location of style dataset')
    parse.add_argument('--vgg' , type=str, default='D:/adain-style-transfer/vgg_normalised.pth',help='Location of pre-trained VGG')
    parse.add_argument('--experiment' , type=str, default='experiment1',help='Name of experiment')

    parse.add_argument('--final_size' ,type =int, default=256, help='size of final image')
    parse.add_argument('--content_size' ,type =int, default=512, help='size of content image')
    parse.add_argument('--style_size' ,type =int, default=512, help='size of style image')
    parse.add_argument('--crop' ,action='store_true', default = True, help='Crop image')
    ...
    parse.add_argument('--lr_decay',type=float,default=5e-5,help='Learning rate deacy')
    parse.add_argument('--epochs' ,type=int , default=3,help ='Number of epoches')

    parse.add_argument('--content_weight' ,type=float , default=1.0,help ='content weight')
    parse.add_argument('--style_weight' ,type=float , default=10,help ='style weight')
    parse.add_argument('--log_interval' ,type=int , default=1,help ='Log interval')
    parse.add_argument('--save_interval' ,type=int , default=2,help ='save interval')
    
    parse.add_argument('--resume' ,action='store_true' , default=False,help ='Resume training')
    parse.add_argument('--optimizer_path' ,type=str , default=None,help ='path to optimizer checkpoint')
